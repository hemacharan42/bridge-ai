          ...
          {filteredCandidates.map((candidate) => {
            ...
            return (
              <div
                ...
                className={`p-5 rounded-2xl border flex flex-col justify-between transition-all space-y-4 shadow-xl group relative ${
                  isCompared
                    ? "bg-slate-900/95 border-cyan-500/60 ring-1 ring-cyan-500/30"
