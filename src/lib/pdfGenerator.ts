...
export async function generateScorecardPdf(options: GeneratePdfOptions): Promise<void> {
  ...
  const notes = [
    report.breakdown.safety_score && report.breakdown.safety_score < 70
      ? "CRITICAL PPE VIOLATION: Bare-hand contact logged at 14.2s (-25 pts). Missing Class 0 1000V dielectric gloves during live conductor isolation."
      : "Zero electrocution hazard: Class 0 1000V dielectric insulated gloves detected throughout active handling step.",
